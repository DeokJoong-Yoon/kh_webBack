 ...
 *	데이터 전달을 목적을 만들어진 클래스이다.
 *	VO 클래스는 어플리케이션 구조에서 단계의 입출력 정보를 전달하는 역할을 수행하며,
...
public class SubjectVO {
	...
	private String deleteable; // 삭제가능여부
	...
	public String toString() {
		return "Subject [no=" + no + ", s_num = " + s_num + ", s_name = " + s_name + ", deleteable = " + deleteable
				+ "]";
	}
}
