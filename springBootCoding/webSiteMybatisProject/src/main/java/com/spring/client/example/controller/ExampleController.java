...
public class ExampleController {
	...
	public String exam01(Model model) {
		model.addAttribute("data", "현재 데이터 화면에 출력");
	...
	public String test(Model model) {
		...
		list.add(new ExampleDTO("김철수", 26, "javauser@naver.com"));
		list.add(new ExampleDTO("하늘봄", 32, "jsp1234@naver.com"));
	...
	@GetMapping("/exam02")
	public String examp01(Model model, @ModelAttribute("param1") String param1,
